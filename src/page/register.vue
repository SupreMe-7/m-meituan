    ...
    <div class="content">
      ...
      >
        ...
        <el-form-item label="创建密码" prop="password">
          <el-input type="password" v-model.number="registerForm.password" @input="input"></el-input>
        </el-form-item>
        ...
        <el-form-item label="确认密码" prop="rePassword">
          <el-input type="password" v-model.number="registerForm.rePassword"></el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    input() {
      if (this.registerForm.password.length > 15) {
